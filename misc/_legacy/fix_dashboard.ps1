$path = "c:\UKonekSupabase\frontend\web\js\dashboard.js"
$content = Get-Content $path -Raw
$startMarker = "const row = document.createElement('tr');"
$endMarker = "function clearPharmacySearch()"
...
$newContent = $before + $middle + "`r`n`r`n" + $after
