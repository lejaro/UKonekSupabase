-- =============================================================================
-- Update lookup_prescription_by_code to return per-item dispensed/remaining
-- quantities added by the partial prescription dispense workflow migration.
-- =============================================================================
...
begin
  ...
  -- Doctor name
  select trim(coalesce(s.firstname, coalesce(s.first_name, '')) || ' ' || coalesce(s.surname, coalesce(s.last_name, '')))
  into v_doctor
  from public.staff s
