-- Fix create_queue_ticket function to use correct column name
-- The citizens table has 'auth_user_id' not 'user_id'
...
BEGIN
    ...
    -- FIXED: Changed c.user_id to c.auth_user_id (correct column name)
...
-- Add comment
COMMENT ON FUNCTION create_queue_ticket(TEXT, TEXT, TEXT, TEXT, TEXT) IS 'Creates a new queue ticket with daily limit check. Fixed to use auth_user_id column.';
