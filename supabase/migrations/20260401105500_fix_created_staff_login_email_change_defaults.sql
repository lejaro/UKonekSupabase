-- Fix login for admin-created staff accounts.
-- GoTrue /token may fail when auth.users.email_change is NULL.

-- Backfill existing auth users created with NULL email_change fields.
update auth.users
set
