-- Nurses, staff and specialists can change availability status for any active staff row.
...
begin
  ...
  -- All active staff roles (doctor, nurse, staff, specialist, admin) can update any row.
