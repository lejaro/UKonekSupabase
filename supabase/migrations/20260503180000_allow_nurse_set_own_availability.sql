-- Allow nurses/staff to update their own availability status.
-- Doctors and admins can update any active staff row.
...
begin
  ...
  -- Doctors, admins, nurses and staff can all update any active staff row.
  if v_actor_role in ('doctor', 'admin', 'nurse', 'staff', 'specialist') then
