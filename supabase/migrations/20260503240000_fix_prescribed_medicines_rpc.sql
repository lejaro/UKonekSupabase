-- Fix get_my_prescribed_medicines: remove ticket_code reference on citizens table
-- (citizens has no ticket_code column; use citizen id::text as the match identifier)
